        ...
        <FormItem>
          <FormControl>
            <input
              ...
              inputMode="numeric"
              maxLength={1}
              className="w-12 h-16 text-center text-3xl font-black italic bg-white border border-black focus:outline-none focus:bg-yellow-400 focus:text-black transition-all rounded-none"
              onChange={(e) => {
