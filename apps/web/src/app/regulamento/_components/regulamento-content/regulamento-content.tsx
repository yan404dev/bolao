      ...
      <div className="grid grid-cols-1 gap-4">
        <AccordionItem title="Como ganho pontos?" defaultOpen>
          <div className="space-y-4 text-lg">
            <p className="flex items-center gap-3">
              <span className="bg-yellow-400 text-black px-3 py-1 text-2xl font-black italic border border-black">3</span>
              <span>Acertou o <strong className="uppercase">placar exato</strong> (ex: você disse 2x1, terminou 2x1)</span>
            </p>
            <p className="flex items-center gap-3">
              <span className="bg-gray-200 text-black px-3 py-1 text-2xl font-black italic border border-black">1</span>
              <span>Errou o placar, mas <strong className="uppercase">acertou quem venceu</strong></span>
            </p>
            <p className="flex items-center gap-3">
              <span className="bg-red-500 text-white px-3 py-1 text-2xl font-black italic border border-black">0</span>
        ...
        <AccordionItem title="Quanto preciso fazer para ganhar?">
          <div className="text-xl space-y-4">
            ...
            <p className="bg-gray-100 p-4 border-l border-black italic">Se ninguém atingir 15 pontos, o prêmio acumula para a próxima rodada.</p>
          </div>
        </AccordionItem>

        <AccordionItem title="Como é dividido o prêmio?">
          <div className="space-y-4 text-xl">
            <p>Quem fizer <strong className="uppercase underline decoration-yellow-400 decoration-2">mais pontos leva 100% do prêmio</strong>.</p>
        ...
        <AccordionItem title="Quanto custa participar?">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-6 border border-black bg-white hover:bg-yellow-400 transition-colors">
            ...
            <div className="p-6 border border-black bg-black text-white hover:bg-yellow-400 hover:text-black transition-all">
        ...
        <AccordionItem title="O que acontece se o prêmio acumular?">
          <div className="space-y-4 text-lg">
            ...
            <p>Nesse caso, a aposta sobe para <strong className="bg-yellow-400 px-2 border border-black">R$ 20,00</strong>.</p>
